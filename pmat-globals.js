...
pmat = {
    "api": {
        "loader": function () {
            if (!pm.variables.get('flag_' + pm.info.iteration)) {
                ...
                if (pm.info.iteration === 0) {
                    ...
                    //console.log('in api.loader', pm.environment.values.toJSON());
        ...
        "getValidTestCases": function () {
            testCases = pm.variables.get('testCases');

            //validate dependency    
            if (!testCases) {
                throw {
                    name: 'pmatFlowStateError',
                    message: 'testCases should have been saved as part of the initialization in newRun...'
                };
            }
        }
    },
    ...
    "engine": {
        ...
        "getValidTestCases": function () {
            ...
            /*
                if (testCases.iteration === undefined || testCases.iteration === null) testCases.iteration = 0;
            
                //Calculate testCases.index
                if (testCases.testCase.length) testCases.index = testCases.iteration % testCases.testCase.length;
                else testCases.index = 0;
            */
        },
        ...
        "save": function ({
            ...
            // get current testCases or to initialized otherwise.
            //pmat.engine.getValidTestCases();
